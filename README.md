...
- [TASK2 - Self-study](#task2)
  ...
  - :pencil2: [Algorithm](#-:pencil2:-algorithm)
...
- 'View All Students' to display all student data.
- 'Add Custom Student' to manually add a new student.
...
&#9632; Step 3 - check the output of the result<br>
### Create JSON file
&#9632; Step 1 - Click the button 'Save Current Data'<br>
